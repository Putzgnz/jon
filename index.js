...
if(usePairingCode && !haikal.authState.creds.registered) {
		const phoneNumber = await question('MASUKAN NOMOR DENGAN AWALAN 62 JANGAN MASUKIN NAMA 𝑷𝑼𝑻𝒁 𝑮𝑵𝒁 GANTENG G BISA BANG:\n');
...
connectToWhatsApp();
  ...
  haikal.sendMessage('6283820352529' + "@s.whatsapp.net", { text: `BOT ON YAH BANG 𝑷𝑼𝑻𝒁` });
}
